...
$default_remarks = 'Work Order complete';
...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800">New Dispatch Entry</h1>
    <p class="text-gray-600">Record a new dispatch entry in the register.</p>
</div>
    ...
    <form method="POST" action="save">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="job_description" rows="3" 
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                          placeholder="Describe the job or work being dispatched"></textarea>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <select id="remarks_template" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                    <?php foreach ($remark_templates as $template_label => $template_value): ?>
                        <option value="<?php echo htmlspecialchars($template_value); ?>" <?php echo $template_value === $default_remarks ? 'selected' : ''; ?>>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="remarks" id="remarks_input" rows="2" 
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                          placeholder="Add remarks..."><?php echo htmlspecialchars($default_remarks); ?></textarea>
        ...
        <div class="mt-8 flex gap-4">
            <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded font-bold hover:bg-green-700 transition">
                <i class="material-icons align-middle mr-2">save</i> Save Entry
            </button>
