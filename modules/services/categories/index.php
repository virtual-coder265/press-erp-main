...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Service Categories</h1>
    <div class="space-x-2">
        <a href="../../services/index"
            class="bg-gray-600 text-white px-4 py-2 rounded shadow hover:bg-gray-700 transition">
            <i class="material-icons align-middle">arrow_back</i> Back to Services
        </a>
        ...
        <form action="save" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="submit"
                        class="flex-1 bg-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 transition shadow-lg">Save</button>
                </div>
            </div>
        </form>
    </div>
