...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mt-2">Edit Product</h1>
</div>
    ...
    <form action="save" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" rows="4"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo htmlspecialchars($product['description']); ?></textarea>
        </div>
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit"
                class="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition shadow-lg">Update
                Product</button>
        </div>
    </form>
</div>
