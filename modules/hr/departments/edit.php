...
if (!$dept) {
    redirect('modules/hr/departments/list?error=not_found');
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    redirect('modules/hr/departments/list?success=updated');
}
...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800">Edit Department (Section)</h1>
</div>
...
<div class="bg-white shadow rounded-lg p-8 max-w-lg">
    <form method="POST" action="edit?id=<?php echo (int) $id; ?>">
        <div class="mb-4">
            ...
            <input type="text" name="name" class="w-full border rounded p-2 focus:ring-2 focus:ring-blue-500" value="<?php echo htmlspecialchars($dept['name']); ?>" required>
        </div>
