...
if (!function_exists('get_settings_registry')) {
    function get_settings_registry() {
        ...
        $registry = [
            ...
            'vendor_code' => ['group' => 'bank', 'type' => 'string', 'default' => '0000506232'],
            'bank_name' => ['group' => 'bank', 'type' => 'string', 'default' => 'NBS Bank'],
            'account_number' => ['group' => 'bank', 'type' => 'string', 'default' => '23882768'],
            'collection_account_name' => ['group' => 'bank', 'type' => 'string', 'default' => 'Government Print Treasury Fund'],
